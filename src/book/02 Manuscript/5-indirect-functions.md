...
The transition wasn't entirely seamless: automated systems flagged the new digital signature, so some administrators had to manually approve the update. Fortunately, this update wasn't particularly urgent, no one was going to lose any sleep over a couple translation fixes being delayed, after all.
